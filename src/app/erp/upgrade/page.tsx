...
export default function UpgradePage() {
  ...
  return (
    <div style={{ minHeight: '100%', padding: '4rem 2rem', backgroundColor: '#f8fafc', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
      ...
      {/* Active PRO Banner */}
      <div style={{ backgroundColor: '#d1fae5', border: '1px solid #6ee7b7', color: '#065f46', padding: '1rem 2rem', borderRadius: '12px', display: 'flex', alignItems: 'center', gap: '0.8rem', marginBottom: '2rem', maxWidth: '800px', width: '100%' }}>
        <Crown size={24} color="#10b981" />
        <span style={{ fontWeight: 600 }}>✅ PRO Paket aktivdir. Bütün funksiyalardan məhdudiyyətsiz istifadə edə bilərsiniz.</span>
      </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: '2rem', maxWidth: '1000px', width: '100%' }}>
        ...
        {/* Basic Plan */}
        <div style={{ backgroundColor: 'white', borderRadius: '24px', padding: '2.5rem', border: '1px solid #e2e8f0', boxShadow: '0 4px 6px -1px rgba(0,0,0,0.05)', opacity: 0.6, position: 'relative' }}>
        ...
        {/* PRO Plan */}
        <div style={{ backgroundColor: '#0f172a', borderRadius: '24px', padding: '2.5rem', border: '2px solid #10b981', boxShadow: '0 20px 25px -5px rgba(16,185,129,0.2)', position: 'relative', transform: 'scale(1.05)' }}>
          ...
          <Link href="/erp/dashboard" style={{ display: 'block', width: '100%', textAlign: 'center', padding: '1rem', background: 'linear-gradient(135deg, #10b981 0%, #059669 100%)', color: 'white', textDecoration: 'none', borderRadius: '12px', fontWeight: 700, fontSize: '1rem', transition: 'all 0.2s', boxShadow: '0 4px 6px rgba(16,185,129,0.3)' }} onMouseOver={e => e.currentTarget.style.filter = 'brightness(1.1)'} onMouseOut={e => e.currentTarget.style.filter = 'brightness(1)'}>
            Ana Səhifəyə Qayıt
          </Link>
        </div>
