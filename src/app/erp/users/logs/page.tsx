  ...
  return (
    <div style={{ padding: '2rem' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '2rem' }}>
        <div>
          <h1 style={{ fontSize: '2rem', fontWeight: 800, color: 'var(--text-color)', marginBottom: '0.5rem' }}>Aktivlik logları</h1>
          <p style={{ color: 'var(--text-secondary)' }}>İstifadəçilərin sistemdə etdikləri əməliyyatların izlənməsi.</p>
        </div>
